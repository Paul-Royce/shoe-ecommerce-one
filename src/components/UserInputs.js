...
const UserInputs = ()=> {
    ...
    return (
        <div className="user-inputs-cont">
            <div className="interactive-cont">
                <button className="operand minus" onClick={()=> propContext.subtractItem()}>-</button>
                <div className="item-counter">{propContext.itemCount}</div>
                <button className="operand plus" onClick={()=> propContext.addItem()}>+</button>
            </div>
            <div className="cart-add-btn" onClick={propContext.updateCartItems} role="button" >
